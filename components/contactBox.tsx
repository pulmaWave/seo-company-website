    ...
    <div className='mt-12'>
      <div className='bg-gray-100 shadow rounded p-6 '>
        ...
        <div className='space-y-1 text-base'>
          <div>
            <span className='font-semibold text-sky-700'>Địa chỉ:</span> 25 Đ.
            Số 69 - TML, Phường Thạnh Mỹ Lợi, Thủ Đức, Hồ Chí Minh
          </div>
          <div>
          ...
          <div>
            <span className='font-semibold text-sky-700'>Hotline:</span> (+84)
            975 252 168
          </div>
          <div>
